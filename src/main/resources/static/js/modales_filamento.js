...
$('a.btn-info').click(function () {
    ...
    const fechaRegistro      = modal.querySelector('p[id="fechaRs"]');
    ...
    const celdaFechaRegistro = fila.querySelector('td.d-none.R');
    const celdaFechaEdicion  = fila.querySelector('td.d-none.E');
    ...
    const valorColor        = celdaColor.textContent;
    const valorNotas        = celdaNotas.textContent;
    const valorFechaRegistro= celdaFechaRegistro.textContent;
    ...
    fechaRegistro.textContent       = valorFechaRegistro;
